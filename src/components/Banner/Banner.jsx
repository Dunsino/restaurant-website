        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 place-items-center">
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute top-[50%] right-[50%] transform translate-x-[50%] translate-y-[-50%] h-[320px] w-[320px] bg-lime-200 rounded-full"
            ></motion.div>
          </div>
          ...
          <div className="space-y-5 lg:max-w-[400px]">
            ...
            <motion.p
              ...
              whileInView="show"
            >
              Lorem ipsum dolor sit amet consectetur adipiscing elit. Vero ea
              enim porro!
            </motion.p>
            <motion.button
