      ...
      <div className="container py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 place-items-center">
          ...
          <div className="space-y-5 lg:max-w-[400px]">
            ...
            >
              "Lorem ipsum dolor sit, amet consectetur adipiscing elit, Corrupti
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute top-[50%] right-[50%] transform translate-x-[50%] translate-y-[-50%] h-[300px] w-[300px] bg-lime-200 rounded-full"
            ></motion.div>
          </div>
        </div>
      </div>
